...
// Change the font
draw_set_font(fnt_general_font_1);
...
draw_text_transformed(x, y - 320, string(text_title_world_1), image_xscale, image_yscale, 0);
draw_text_transformed(x, y - 260, string(text_desc_world_1), image_xscale, image_yscale, 0);
